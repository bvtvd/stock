<template>
    <div>
                ...
                <template slot-scope="props">
                    <el-form label-position="left" inline class="demo-table-expand">
                        ...
                        <el-form-item label="出库金额">
                            <span>{{ props.row.outgoing_money }}</span>
                        </el-form-item>
                        <el-form-item label="增值税">
                            <span>{{ props.row.value_added_tax }}</span>
                        </el-form-item>
                        <el-form-item label="3%代扣税">
                            <span>{{ props.row.withholding_tax }}</span>
                        </el-form-item>
                        <el-form-item label="应收金额">
                            <span>{{ props.row.receivable_money }}</span>
                        </el-form-item>
        ...
        >
            <template slot-scope="scope">
                <span v-for="(item) in scope.row.product">{{fmoney(item.product_price)}}<br></span>
            </template>
        </el-table-column>
            <el-table-column
                    prop="outgoing_quantity"
        ...
        <el-dialog :title="dialogTitle" :visible.sync="dialogFormVisible">
            <el-form :model="formData"  :rules="rules" ref="ruleForm"  :label-width="formLabelWidth">
                ...
                <el-form-item label="商家名称" :label-width="formLabelWidth">
                    <el-select style="width: 420px" v-model="formData.business_id"  placeholder="请选择商家名称">
                        <el-option
        ...
        <el-dialog title="出库时间" :visible.sync="dialogMoneyVisible">
            <el-form :model="formData"  :rules="rules" ref="ruleForm"  :label-width="formLabelWidth">
